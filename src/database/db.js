...
function normalizeTelemetry(rawTel = {}, rawIos = {}, calculatedLiters = null, mileageMetrics = {}, gps = {}) {
  ...
  return {
    ...
    fuelPercentage: rawTel.fuelLevelPercentage !== undefined ? Math.min(100, Math.max(0, Math.round(rawTel.fuelLevelPercentage))) : (rawTel.fuelLevel !== undefined ? Math.min(100, Math.max(0, Math.round(rawTel.fuelLevel))) : (fuelLevelLiters ? Math.min(100, Math.round((fuelLevelLiters / 55) * 100)) : 0)),
